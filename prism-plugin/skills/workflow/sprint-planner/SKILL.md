...
Organize Prism OS tasks or user stories into time-boxed sprints for teams using Scrum or sprint-based workflows. Handles capacity planning, dependency ordering, and sprint goal definition.
