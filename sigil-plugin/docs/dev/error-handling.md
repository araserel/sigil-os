...
> Unified error taxonomy and recovery procedures across Sigil agents and skills.

---

## Overview

This document defines how errors are classified, communicated, and resolved throughout the Sigil workflow. Consistent error handling ensures:
