...
> Complete guide for creating new Sigil skills.

---

## Overview

Skills are reusable, chainable units of work that encapsulate specific capabilities. This guide covers everything you need to create new skills for Sigil.

---

## Skill Categories

Sigil organizes skills into 8 categories. Before creating a new skill, review existing ones to avoid duplication.
...
| **Shared Context** | Cross-project sync | `shared-context-sync`, `connect-wizard`, `profile-generator` |
...
3. **Does a similar skill exist?** (Check `sigil-plugin/skills/`)
...
1. Copy the template from `sigil-plugin/templates/skill-template.md`
...
2. Update `sigil-plugin/skills/README.md` with the new skill entry
