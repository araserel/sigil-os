---
name: story-preparer
description: Converts Sigil OS tasks to user story format for Jira, Linear, or story-based workflows. Invoke when user requests stories, mentions Jira/Linear, or needs exportable format.
version: 1.0.0
category: workflow
chainable: true
invokes: []
...
Transform Sigil OS task breakdowns into user story format compatible with external project management tools. Enables seamless handoff to teams using Jira, Linear, Asana, or other story-based workflows.
