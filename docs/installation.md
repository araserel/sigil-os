...
Before installing Prism, you need:
...
> **Note:** If you don't have Claude Code yet, see [Anthropic's documentation](https://docs.anthropic.com/en/docs/claude-code) for detailed setup instructions.
