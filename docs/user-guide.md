...
```
┌─────────────────────────────────────────────────────────────────┐
│  ASSESS  →  SPECIFY  →  CLARIFY  →  PLAN  →  TASKS  →  HANDOFF │
│     │          │           │          │        │          │     │
│  Evaluate   Create     Resolve    Generate  Create     Give to  │
│  scope      spec       questions   plan     tasks      engineers│
└─────────────────────────────────────────────────────────────────┘
```

**Assess:** Prism evaluates your description and selects the appropriate track.
...
**Handoff:** Everything is packaged for your engineering team.
